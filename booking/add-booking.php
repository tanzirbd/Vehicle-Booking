...
$message = '';
if (isset($_POST['btn'])) {
    $message = Booking::saveAllBookingInfo($_POST);
}
    ...
    <div class="row">
        <div class="col-sm-10 col-sm-offset-1">
            <form class="form-horizontal" action="" method="POST" enctype="multipart/form-data">
                <h3 class="text-center text-primary">Add Booking</h3>
                <hr/>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control" id="slectDest" name="destination" required>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control" id="selectCar" name="car_number" required>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input type="number" class="form-control" name="passenger" minlength="1" maxlength="15" required >
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control" id="selectPickup" name="pickup_from" required>
                    ...
                    <div class='col-sm-4'>
                        <div class="form-group">
                            <div class='input-group date' id='datetimepicker6'>
                                <input type='text' class="form-control" name="booking_time" required />
                    ...
                    <div class='col-sm-4'>
                        <div class="form-group">
                            <div class='input-group date' id='datetimepicker7'>
                                <input type='text' class="form-control" name="return_time" required />
                                <span class="input-group-addon">
                    <span class="glyphicon glyphicon-calendar"></span>
                </span>
                            </div>
